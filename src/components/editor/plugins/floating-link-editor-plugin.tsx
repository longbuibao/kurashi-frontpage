...
function FloatingLinkEditor ({
  ...
  useEffect(() => {
    if (isLinkEditMode && (inputRef.current != null)) {
      ...
      if ($isRangeSelection(selection)) {
        ...
        const badNode = selection
          ...
          .find((node) => {
            ...
            return (
              ((focusLinkNode != null) && !focusLinkNode.is(linkNode)) ||
              ((linkNode != null) && !linkNode.is(focusLinkNode)) ||
              ((focusAutoLinkNode != null) && !focusAutoLinkNode.is(autoLinkNode)) ||
              ((autoLinkNode != null) &&
