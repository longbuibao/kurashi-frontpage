...
function TableCellResizer ({ editor }: { editor: LexicalEditor }): JSX.Element {
  ...
  useEffect(() => {
    return editor.registerNodeTransform(TableNode, (tableNode) => {
      if (tableNode.getColWidths() != null) {
        return tableNode
      }
  ...
  useEffect(() => {
    const onMouseMove = (event: MouseEvent) => {
      setTimeout(() => {
        ...
        if ((resizerRef.current != null) && resizerRef.current.contains(target as Node)) {
          return
        }
  ...
  const mouseUpHandler = useCallback(
    (direction: MouseDraggingDirection) => {
      const handler = (event: MouseEvent) => {
        ...
        if (mouseStartPosRef.current != null) {
  ...
  const getResizers = useCallback(() => {
    if (activeCell != null) {
      ...
      if (draggingDirection && (mouseCurrentPos != null) && (tableRect != null)) {
      ...
      {activeCell != null && !isMouseDown && (
        <>
          <div
            ...
            style={(resizerStyles.right != null) || undefined}
            onMouseDown={toggleResize('right')}
          />
          <div
            className='TableCellResizer__ui absolute'
            style={(resizerStyles.bottom != null) || undefined}
