...
const AboutKurashiCard: React.FC<AboutKurashiCardProps> = ({ lng }) => {
  ...
  return (
    <div className='max-lg:flex-col max-lg:w-full max-lg:mx-1 relative bg-about'>
      ...
      <Image className='max-md:hidden h-full w-full max-md:object-fill' alt='về Kurashi' src='https://storage.googleapis.com/kurashi_frontpage_files/images/about_home_page_new_800_height_black_bg.jpg' width={1920} height={850} />
