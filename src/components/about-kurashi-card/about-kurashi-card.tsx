  ...
  return (
    <div className='flex flex-row gap-8 max-lg:flex-col max-lg:w-full max-lg:mx-1'>
      ...
      <div className='flex flex-col gap-5 w-1/2'>
        ...
        <div className='text-2xl max-lg:mx-auto text-main'>{t(aboutContentTitle)}</div>
        ...
        <div className='w-fit mt-auto mr-auto max-lg:mx-auto'>
          <Link href='/about'>
            <div className='flex flex-row px-2 py-2 text-main bg-secondary'>
              <div>{t(readMore)}</div>
