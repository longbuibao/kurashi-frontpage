...
const AboutPage: React.FC = () => {
  return (
    <div className='w-4/5 mx-auto pb-10 my-20 max-md:my-3'>
      <div className='flex flex-col gap-10 w-4/5 mx-auto max-md:w-full max-md:text-center'>
        <div className='flex flex-row gap-5 max-md:flex-col items-center'>
          <div className='max-md:mt-10 flex flex-col gap-5 w-1/2 p-10 max-md:p-0 border-r-[1px] border-[rgba(0,0,0,0.3)] max-md:border-none max-md:w-full max-md:flex-col-reverse'>
        ...
        <div className='flex flex-row gap-5 max-md:flex-col max-md:gap-10 mt-10'>
          <div className='flex flex-col gap-5 max-md:gap-3 w-1/2 border-r-[1px] border-[rgba(0,0,0,0.56)] max-md:border-none max-md:w-full max-md:p-0 pr-10'>
            ...
            <div className='flex flex-col gap-5 mt-5 pr-[3rem] max-md:pr-0 max-md:mt-3'>
          ...
          <div className='flex flex-col gap-5 w-1/2 max-md:p-0 max-md:w-full pl-32 max-md:mt-5'>
