...
export const blogImageUrls = [
  { imageUrl: 'https://storage.googleapis.com/kurashi_frontpage_files/images/thep_trang_men_slider/10.jpg', content: 'Chỉ 1 phụ kiện nhưng tích hợp 2 chức năng vừa là kệ đựng hũ gia vị, vừa là móc treo.', title: 'Kệ đựng tích hợp móc treo' },
  { imageUrl: 'https://storage.googleapis.com/kurashi_frontpage_files/images/thep_trang_men_slider/11.jpg', content: 'Tùy ý chỉnh chiều dài để đặt hộp giấy, thớt hoặc thậm chí iPad', title: 'Kệ đựng di động' },
  { imageUrl: 'https://storage.googleapis.com/kurashi_frontpage_files/images/thep_trang_men_slider/12.jpg', content: 'Treo tối đa 3 khăn xen kẽ, ngay trước mặt, luôn khô ráo, sạch sẽ', title: 'Móc treo khăn 3 nhánh' }
].map(x => {
  return {
    key: x.imageUrl,
    image: (
