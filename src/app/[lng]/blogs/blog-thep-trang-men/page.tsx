  ...
  return (
    <div className='w-4/5 mx-auto my-10'>
      <div className='w-[70%] mx-auto'>
        ...
        <div className='flex flex-row gap-10 my-10 p-10 bg-blog'>
        ...
        <div>
          ...
          <div className='flex flex-row gap-10 mt-10'>
            {images.map(x => (
              <div key={x.imageUrl} className='h-[30vh] w-1/4'>
                <Image className='h-1/2' src={x.imageUrl} width={100} height={100} alt='tính năng của thép tráng men' />
                <div className='mt-3'>
                  <div>
                    {x.title}
                  </div>
          ...
          <div className='p-10 flex flex-row gap-10 bg-blog'>
            <div>
              <div className='text-2xl font-bold my-10'><h2>VẬN CHUYỂN TỚI CÔNG TRÌNH DỄ DÀNG</h2></div>
