...
const PartIntro: React.FC<Props> = ({ setCurrentInViewDivId }) => {
  ...
  return (
    <div ref={ref} id={`${c.intro}`} className='relative'>
      <div className='my-10 max-md:text-center'>Vật liệu ốp tường Nhật Bản có lớp thép từ tính, không cần khoan khi gắn phụ kiện. Giải pháp sang trọng cho bếp, lavabo, lối ra vào và các mảng tường nội thất.</div>
